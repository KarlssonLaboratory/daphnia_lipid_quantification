...
load_experiment <- function(experiment) {
  ...
  data_dir <- file.path("data/TBT-CL chronic offspring", experiment)
  ...
  treatment$mother <- as.factor(treatment$mother)
...
# =============================================================================
all_experiments <- list.dirs("data/TBT-CL chronic offspring/", full.names = FALSE, recursive = FALSE)
